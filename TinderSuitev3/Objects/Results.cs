...
namespace TinderSuitev3.Objects
{
    public class Results
    {
        ...
        [JsonProperty("common_interests")] public IList<CommonInterest> CommonInterests { get; set; }

        [JsonProperty("common_friends")] public IList<object> CommonFriends { get; set; }

        [JsonProperty("_id")] public string Id { get; set; }

        [JsonProperty("badges")] public IList<object> Badges { get; set; }
        ...
        [JsonProperty("photos")] public IList<UserResultPhoto> Photos { get; set; }
        ...
        [JsonProperty("common_connections")] public IList<CommonConnection> CommonConnections { get; set; }
    }
}