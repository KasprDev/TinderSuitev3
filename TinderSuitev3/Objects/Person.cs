...
namespace TinderSuitev3.Objects
{
    public class Person
    {
        ...
        [JsonProperty("photos")] public IList<TinderPhoto> Photos { get; set; }

        [JsonProperty("badges")] public IList<object> Badges { get; set; }

        [JsonProperty("hide_age")] public bool? HideAge { get; set; }

        [JsonProperty("hide_distance")] public bool? HideDistance { get; set; }
    }
}